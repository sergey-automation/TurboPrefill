...
// Port target: ik_llama.cpp, commit 5763a901de3f525b65ed5574fd57623905685755
// TurboPrefill_ik_llama_5763a901_v6.3.2
//
...
static int llama_decode_internal(
    ...
    if (n_tokens_all >= turboprefill_threshold) {
        LLAMA_LOG_INFO(
                "%s: TurboPrefill requested=%d active=%d n_tokens=%u n_ubatch=%u full_ubatches=%u devices=%d split_mode=%d nextn_layers=%d\n",
                __func__,
