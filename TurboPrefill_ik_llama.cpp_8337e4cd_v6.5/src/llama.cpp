...
static size_t llama_output_reserve(llama_context & lctx, size_t n_outputs) {
    return llama_output_reserve_split(lctx, n_outputs, n_outputs, n_outputs);
}
...
static int llama_decode_internal(
    ...
    for (uint32_t cur_token = 0; cur_token < n_tokens_all; ) {
                ...
                case LLAMA_POOLING_TYPE_NONE:
                    {
                        ...
                        if (n_outputs_new_embd) {
                            ...
                            if (has_mtp && lctx.turboprefill.stage > 0 &&
        ...
        cur_token += n_tokens;
        if (reset_previous || lctx.turboprefill.stage < 0) {
