...
# Benchmark configuration for bench_Qwen_3.8_ik.py.
# The benchmark is intended to be launched from the ik_llama.cpp / TurboPrefill checkout being tested.
...
# OUTPUT_DIR="$RUN_DIR/bench_reports_Qwen3.8-27B-BF16_ik"

# --- Qwen3.8-27B Q8_0 (ACTIVE DEFAULT) ---
 MODEL="/mnt/models/AI/LLM/Qwen3.8-27B-Q8_0.gguf"
 OUTPUT_DIR="$RUN_DIR/bench_reports_Qwen3.8-27B-Q8_0_ik_1708"

# --- Qwen3.8-27B Q4_K_M ---
# MODEL="/mnt/models/AI/LLM/Qwen3.8-27B-Q4_K_M.gguf"
# OUTPUT_DIR="$RUN_DIR/bench_reports_Qwen3.8-27B-Q4_K_M_ik"

# --- Qwen3.6-27B Q8_0 ---
# MODEL="/mnt/models/AI/LLM/Qwen3.6-27B/Qwen3.6-27B-Q8_0.gguf"
# OUTPUT_DIR="$RUN_DIR/bench_reports_Qwen3.6-27B-Q8_0_ik"
...
# OUTPUT_DIR="$RUN_DIR/bench_reports_Qwen3.6-27B-Q4_K_M_ik"

# --- Qwen3.6-35B-A3B Q8_0 ---
# MODEL="/mnt/models/AI/LLM/Qwen_Qwen3.6-35B-A3B-Q8_0.gguf"
# OUTPUT_DIR="$RUN_DIR/bench_reports_Qwen3.6-35B-A3B-Q8_0_ik"

# --- Qwen3.6-35B-A3B Q4_K_L ---
# MODEL="/mnt/models/AI/LLM/Qwen_Qwen3.6-35B-A3B-Q4_K_L.gguf"
# OUTPUT_DIR="$RUN_DIR/bench_reports_Qwen3.6-35B-A3B-Q4_K_L_ik"
...
# RU: Для MTP замените строку выше на SPEC_TYPE=mtp. Число ниже задаёт максимум draft-токенов за шаг.
# EN: For MTP replace the line above with SPEC_TYPE=mtp. The value below sets the maximum number of drafted tokens per step.

SPEC_TYPE=mtp
SPEC_DRAFT_N_MAX=3

# RU: Путь к отдельной draft-модели для draft и аналогичных режимов. Пусто = отдельная draft-модель не используется.
# EN: Path to a separate draft model for draft and similar modes. Empty = no separate draft model.
SPEC_DRAFT_MODEL=""
