...
GGML_CALL static enum ggml_status ggml_backend_cuda_graph_compute_impl(ggml_backend_t backend, ggml_cgraph * cgraph, bool force_no_graph) {
    ggml_backend_cuda_context * cuda_ctx = (ggml_backend_cuda_context *)backend->context;
    ...
    bool use_cuda_graph = !force_no_graph && !disable_cuda_graphs_due_to_env && cuda_ctx->use_cuda_graph;
...
GGML_CALL static enum ggml_status ggml_backend_cuda_graph_compute(ggml_backend_t backend, ggml_cgraph * cgraph) {
    return ggml_backend_cuda_graph_compute_impl(backend, cgraph, false);
}

extern "C" GGML_CALL enum ggml_status ggml_backend_cuda_graph_compute_no_graph(
        ggml_backend_t backend, ggml_cgraph * cgraph);

GGML_CALL enum ggml_status ggml_backend_cuda_graph_compute_no_graph(
        ggml_backend_t backend, ggml_cgraph * cgraph) {
    return ggml_backend_cuda_graph_compute_impl(backend, cgraph, true);
}
